    ...
    public partial class MainWindow : System.Windows.Window
    {
        ...
        public MainWindow()
        {
           ...
           // System.Windows.MessageBox.Show("Hi");
            ...
            equityDailyUpdateFile = "C:\\Users\\butolea\\Downloads\\OptionLovers-master\\Ety.xlsx";
           ...
           // equityDailyUpdateFileOutputDirectory = dInfo + "\\OutputDaily\\Equity.xlsx";
            ...
            equityDailyUpdateFileOutputDirectory = "C:\\Users\\butolea\\Downloads\\OptionLovers-master\\Equity.xlsx";
            openlowstrategyyDailyUpdateFileOutputDirectory = dInfo + "\\OutputDaily\\OpenLowHighStrategy.xlsx";

            //Stocks URl
            stockArrayList = new string[] { "FCONSUMER", "sbin", "PNB" , "YESBANK","HDFCBANK", "INFY", "WIPRO", "TCS", "ZENSARTECH", "SUNPHARMA",
                "BAJAJ-AUTO", "EASUNREYRL", "HCC", "CIPLA", "TITAN", "BATAINDIA", "RELIANCE", "ZEEL", "MARUTI", "HDFC"
            ,"HINDUNILVR", "BPCL","ASHOKLEY", "AXISBANK","BERGEPAINT", "BAJFINANCE","IDBI", "BHARTIARTL","BOSCHLTD", "COALINDIA",
             "DABUR", "BIOCON","HINDZINC", "ICICIBANK","IBULHSGFIN", "IOC","LT", "LICHSGFIN","NMDC", "LUPIN","ADVENZYMES", "JUBLFOOD","CASTROLIND","TECHM","TATAELXSI",
             "CADILAHC","NIFTY","DEN","RBLBANK","BANKBARODA","LEMONTREE","HIMATSEIDE","KEI","KEC","NHPC","NTPC","NCC","BAJAJFINSV",
             "TATAMOTORS","ITC","KOTAKMahindra","ONGC","HCL","DLF","AMBUJACEMENT","IRCTC","Trident",/*"GAI",*/"NMI","FB","gujaratgas",
             "Tipsindustries","JumpNetworks","TejasNetwork","Gppetroleums","ASIANPAINT","UPL","CASTROL","COLPAL","BANKNIFTY"
            };

            //"HPC","PCBL","NT","PhoenixMills",
            ...
            // "MAHLOG","TVTODAY","DELTACORP","DCBBANK","DHANI"
        ...
        private async void buttonEquityDaily_Click1()
        {
            ...
            foreach (var stockUrl in stockHighLowURLArrayList.Select((value, zm) => new { zm, value }))
            {
                ...
                if (DateTime.Now.DayOfWeek.ToString() == "Monday1")
                {
                ...
                i++;
                //outRefParams.stockTodayClosedPrice = (double)((worKsheeT.Cells[lastUsedRow, i] as Microsoft.Office.Interop.Excel.Range).Value);
                //outRefParams.stockTodayClosedPrice = (double)((worKsheeT.Cells[lastUsedRow, i-1] as Microsoft.Office.Interop.Excel.Range).Value);
                ...
                if (DateTime.Now.DayOfWeek.ToString() == "Monday1")
                {
                    ...
                    {
                        weekPrice[0] = double.Parse(outRefParams.stockTodayClosedPrice);
                        int k = 1;
                        double max, min;
                        ...
                        else if (System.IO.File.Exists(path))
                        {
                            using (var tw1 = new StreamWriter(path, true))
                            {
                                ...
                                {
                                    tw1.WriteLine("=============================================================================================================================================================================================================================");
                                    tw1.WriteLine("", DateTime.Today);
                                    firstLine = false;
                                }
                                if (!string.IsNullOrEmpty(outRefParams.stockName))
                                {
                                    tw1.WriteLine("{0} Buy above {1}. Sell below {2}", outRefParams.stockName.ToUpper(), max, min);
                                }
                                    
                                    if (outRefParams.stockName == null)
                                    {
                                        outRefParams.stockName = "Nifty";
                                        tw1.WriteLine("{0} Buy above {1}.Sell below {2}", outRefParams.stockName.ToUpper(), max, min);
                                    }
                                    //firstLine = false;
